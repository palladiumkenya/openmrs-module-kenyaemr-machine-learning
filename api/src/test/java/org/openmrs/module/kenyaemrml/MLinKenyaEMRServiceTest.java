...
/**
 * This is a unit test, which verifies logic in MLinKenyaEMRService. It doesn't extend
 * BaseModuleContextSensitiveTest, thus it is run without the in-memory DB and Spring context.
 */
public class MLinKenyaEMRServiceTest {
	
	@InjectMocks
	MLinKenyaEMRServiceImpl basicModuleService;
