...
public class StreamProcessorException extends RuntimeException {
	 ...
	 * @since 1.4
	 */
	public StreamProcessorException(final Throwable cause) {
		super(cause);
	}
	 ...
	 */
	public StreamProcessorException(final String message) {
		super(message);
	}
	 ...
	 * @since 1.4
	 */
	public StreamProcessorException(final String message, final Throwable cause) {
		super(message, cause);
	}
